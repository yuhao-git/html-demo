...
const menus = computed(() => ([
  ...
  { title: t('home.video'), router: 'video' },
]))
</script>

<template>
  <Container>
    <var-paper m-15 radius="10" :elevation="2">
      <var-cell border>
        {{ t('home.darkMode') }}
        <template #extra>
      ...
      <var-cell v-for="(item, index) in menus" :key="item.router" :border="index !== menus.length - 1" ripple
