...
export default class lineMap {
    ...
    loadMapData() {
        ...
        map.features = jsonData.features.map(item => {
    ...
    initMap(chinaJson) {
        ...
        let _this = this;
        // 绘制地图
        // new THREE.TextureLoader().load(mapUrl, function (cubeTexture) {
        let textureLoader = new THREE.TextureLoader();
        let mdTexture = textureLoader.load(mdUrl)
